...
tk.Button(root, text="Exit", width=40, command=exit_prog).grid(row=5, sticky="E")
tk.Button(root, text="Apply", width=40, command=apply_settings).grid(row=5, sticky="W")
tk.Button(root, text="Reset", width=40, command=reset_settings).grid(column=0, row=5)

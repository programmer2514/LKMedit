...
def update_vpad_color():
    for i in range(18):
        ...
        if i == 0:
            p0.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 1:
            p1.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 2:
            p2.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 3:
            p3.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 4:
            p4.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 5:
            p5.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 6:
            p6.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 7:
            p7.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 8:
            p8.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 9:
            p9.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 10:
            p10.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 11:
            p11.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 12:
            p12.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 13:
            p13.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 14:
            p14.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 15:
            p15.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 16:
            p16.configure(bg = vpad_color[0], activebackground = vpad_color[1])
        if i == 17:
            p17.configure(bg = vpad_color[0], activebackground = vpad_color[1])
...
tk.Button(root, text="Exit", width=46, command=exit_prog).grid(row=5, sticky="E")
tk.Button(root, text="Apply", width=46, command=apply_settings).grid(row=5, sticky="W")
tk.Button(root, text="Reset", width=46, command=reset_settings).grid(column=0, row=5)
...
p0_id = p0.bind('<Button-3>', set_button_0)
p1_id = p1.bind('<Button-3>', set_button_1)
p2_id = p2.bind('<Button-3>', set_button_2)
p3_id = p3.bind('<Button-3>', set_button_3)
p4_id = p4.bind('<Button-3>', set_button_4)
p5_id = p5.bind('<Button-3>', set_button_5)
p6_id = p6.bind('<Button-3>', set_button_6)
p7_id = p7.bind('<Button-3>', set_button_7)
p8_id = p8.bind('<Button-3>', set_button_8)
p9_id = p9.bind('<Button-3>', set_button_9)
p10_id = p10.bind('<Button-3>', set_button_10)
p11_id = p11.bind('<Button-3>', set_button_11)
p12_id = p12.bind('<Button-3>', set_button_12)
p13_id = p13.bind('<Button-3>', set_button_13)
p14_id = p14.bind('<Button-3>', set_button_14)
p15_id = p15.bind('<Button-3>', set_button_15)
p16_id = p16.bind('<Button-3>', set_button_16)
p17_id = p17.bind('<Button-3>', set_button_17)
